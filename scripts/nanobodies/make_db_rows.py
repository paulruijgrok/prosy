...
``Nanobodies`` sheet of ``plasmid_database.xlsx`` — so the block can be
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument("--sheet-xlsx", type=Path, default=None,
                   help="Lab spreadsheet (default: <data-dir>/plasmid_database.xlsx).")
...
def main(argv: list[str] | None = None) -> int:
    ...
    sheet_path = args.sheet_xlsx or data_dir / "plasmid_database.xlsx"
