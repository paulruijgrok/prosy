...
--------------------------
For 12 parent nanobodies (7 from SetA: Nb01-Nb07; 5 from SetB: Nb50-53, Nb58)
...
SetA_PARENTS = ["Nb01", "Nb02", "Nb03", "Nb04", "Nb05", "Nb06", "Nb07"]
SetB_PARENTS = ["Nb50", "Nb51", "Nb52", "Nb53", "Nb58"]
PARENT_ORDER = SetA_PARENTS + SetB_PARENTS
...
# TSV files per set.
TSV_BY_SET = {
    "SetA": "recommendations_SetA.tsv",
    "SetB": "recommendations_SetB.tsv",
}
...
def main() -> None:
    ...
    xlsx = data_dir / "plasmid_database.xlsx"
